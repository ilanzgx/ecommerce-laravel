<template>
  <div class="flex mx-6 my-6">
    <div class="flex flex-col max-w-md m-auto bg-gray-700 px-14 py-14 md:px-12 md:py-12 rounded-md shadow-md">
      ...
      <form class="text-gray-400 space-y-12" action="">
        <div class="space-y-4">
          <div class="">
            <label class="block mb-2 text-gray-200" for="text_email">Endereço de email</label>
            <input class="w-full text-gray-300 px-4 py-2 rounded-md bg-gray-700 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-opacity-0 focus:ring-opacity-50" id="text_email" type="text" placeholder="Ex: joaozinho@gmail.com">
          </div>
          ...
          <input class="w-full text-gray-100 px-4 py-2 rounded-md bg-gray-700 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-opacity-0 focus:ring-opacity-50" type="password" id="text_senha" placeholder="*****">
        </div>
        
        <div class="space-y-2">
          <button class="w-full bg-purple-400 text-gray-900 px-8 py-4 rounded-md">Entrar</button>
