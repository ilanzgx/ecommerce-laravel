      ...
      <div class="flex justify-between">
        <div class="flex space-x-4">
          ...
          <div class="hidden md:flex items-center space-x-1">
            <div class="py-4 px-3 w-full">
              <input class="w-full bg-transparent ring-1 ring-gray-200 italic text-sm rounded-lg py-2 px-6 focus:outline-none transition duration-250 ease-in-out placeholder-white placeholder-opacity-100 focus:placeholder-opacity-30 focus:ring-2 focus:ring-purple-400" placeholder="O que você procura?" type="text" name="" id="">
            </div>
          </div>
        </div>
        <!-- secondary nav -->
        <div class="hidden md:flex items-center space-x-2">
            ...
            <Link :href="$route('carrinho')" class="block md:inline no-underline py-4 md:py-0 hover:text-gray-200">
              ...
              <small class="mx-2 md:mx-3">Carrinho (0)</small>
            </Link>
            ...
            <Link :href="$route('login')" :data="{shiba: false}" class="py-2 px-3 font-bold bg-purple-800 hover:bg-purple-900 text-purple-400 hover:text-purple-200 rounded transition duration-200">
              Cadastrar
            </Link>
        </div>
