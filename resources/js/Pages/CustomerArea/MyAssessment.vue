  ...
  <div>
    ...
    <div class="my-4 mx-2">
      ...
      <form @submit.prevent="sendData">
        ...
        <div>
          <label class="text-gray-50 text-sm" for="">Texto do que você achou</label>
        ...
        <t-alert class="my-2 text-black" v-if="response != undefined && response.message" :variant="response.success ? 'success' : 'danger'" show>
          {{ response.message }}
        </t-alert>
