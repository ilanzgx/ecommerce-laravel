...
class Payload{
    ...
    /**
     * Método responsável por definir o valor de $setDescription
     * @param string
     */
    ...
    /**
     * Método responsável por definir o valor de $pxid
     * @param string
     */
    ...
    /**
     * Método responsável por retornar o valor completo do payload
     * @param string $id
     * @param string $value
    ...
    /**
     * Método responsável por retornar os valores completos do campo adicional da pix (txid)
     * @return string 
     */
    ...
    */
    ...
    /**
     * Método responsável por gerar o codigo completo do payload pix
     * @param string
     */
